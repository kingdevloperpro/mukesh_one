...
public class one_ed__Lst_Act extends AppCompatActivity implements View.OnClickListener {
...
//        txtShare.setOnClickListener(new C30254(this));
        txtShare.setOnClickListener(new one_Loan_OneTap() {
            @Override
    ...
    public void onClick(View view) {
        Intent intent = new Intent(this, one_d_IFSC.class);
        switch (view.getId()) {
            case R.id.txtBank:
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(R.layout.jahir__loan_activity_ifscbank_list);

        activity = one_ed__Lst_Act.this;
        ...
        if (isOnline()) {
            ...
            new Handler().postDelayed(new Runnable() {
                ...
                public void run() {
                    one_ed__Lst_Act.this.progressDialog.isShowing();
                    one_ed__Lst_Act.this.progressDialog.dismiss();
                }
            }, 3000);
        }
    ...
    public void ironfullscreen(final int i) {
        ...
        one_ed__Lst_Act.this.progressBar.dismiss();
        one_ed__Lst_Act.this.click(i);
    }
    ...
    class C30221 implements Runnable {
        final one_ed__Lst_Act f12907a;

        C30221(one_ed__Lst_Act iFSCbankListActivityVB) {
    ...
    public class C30232 implements View.OnClickListener {
        final one_ed__Lst_Act f12908a;

        C30232(one_ed__Lst_Act iFSCbankListActivityVB) {
    ...
    public class C30243 implements View.OnClickListener {
        final one_ed__Lst_Act f12909a;

        C30243(one_ed__Lst_Act iFSCbankListActivityVB) {
    ...
    public class C30254 implements View.OnClickListener {
        final one_ed__Lst_Act f12910a;

        C30254(one_ed__Lst_Act iFSCbankListActivityVB) {
    ...
    class C30265 implements View.OnClickListener {
        final one_ed__Lst_Act f12911a;

        C30265(one_ed__Lst_Act iFSCbankListActivityVB) {
