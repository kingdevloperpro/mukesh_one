...
public class one_e_CashCount extends AppCompatActivity {
    TextView editext;
    TextView editext10;
    TextView editext100;
    TextView editext20;
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(R.layout.jahir__loan_act_cash_count);
        ...
        TextWatcher r2 = new TextWatcher() {
            ...
            public void onTextChanged(CharSequence charSequence, int i, int i2, int i3) {
                one_e_CashCount VBCashCountActs = one_e_CashCount.this;
        ...
        imgshare.setOnClickListener(new one_d_oan_One_clk() {
            @Override
        ...
        imgadd.setOnClickListener(new one_d_oan_One_clk() {
            @Override
            public void performClick(View v) {
                one_e_CashCount VBCashCountActs = one_e_CashCount.this;
        ...
        imgminus.setOnClickListener(new one_d_oan_One_clk() {
            @Override
            public void performClick(View v) {
                one_e_CashCount VBCashCountActs = one_e_CashCount.this;
                VBCashCountActs.numberOfTaps = Integer.parseInt(VBCashCountActs.editext.getText().toString()) - 1;
