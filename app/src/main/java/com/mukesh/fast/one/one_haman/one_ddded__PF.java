...
public class one_ddded__PF {
    public static String SPIN = "10";
    public static SharedPreferences _sharedPreferences;
    private Activity activity;

    public one_ddded__PF(Activity activity2) {
        this.activity = activity2;
    }

    public static SharedPreferences sharedPreferences() {
        SharedPreferences sharedPreferences = one_aavechebahiLoan_MBit.getContext().getSharedPreferences("PrefData", 0);
    ...
    public static Bitmap getSelfie() {
        if (!sharedPreferences().contains("selfie")) {
            return BitmapFactory.decodeResource(one_aavechebahiLoan_MBit.getContext().getResources(), R.drawable.ic_default_user);
        }
