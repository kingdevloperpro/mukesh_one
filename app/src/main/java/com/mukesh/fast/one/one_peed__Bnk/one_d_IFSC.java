...
public class one_d_IFSC extends AppCompatActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(R.layout.jahir_loan_activity_ifsclist);
        ...
        if (isOnline()) {
            ...
            new Handler().postDelayed(new Runnable() {
                ...
                public void run() {
                    one_d_IFSC.this.progressDialog.isShowing();
                    one_d_IFSC.this.progressDialog.dismiss();
                }
            }, 3000);
        }
        int i = 0;
    ...
    public class C3021a extends RecyclerView.Adapter<C3021a.C3020a> {
        final one_d_IFSC f12897a;

        public C3021a(one_d_IFSC iFSCListActivityVB) {
            this.f12897a = iFSCListActivityVB;
        }

        public C3020a m16686a(ViewGroup viewGroup, int i) {
            return new C3020a(this, LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.jahir_loan_row_list_ifsc, (ViewGroup) null));
        }
